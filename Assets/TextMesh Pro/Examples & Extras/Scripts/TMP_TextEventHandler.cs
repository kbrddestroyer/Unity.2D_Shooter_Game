...
namespace TMPro
{
    ...
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        [SerializeField]
        protected CharacterSelectionEvent m_OnCharacterSelection = new CharacterSelectionEvent();
        ...
        [SerializeField]
        protected SpriteSelectionEvent m_OnSpriteSelection = new SpriteSelectionEvent();
        ...
        [SerializeField]
        protected WordSelectionEvent m_OnWordSelection = new WordSelectionEvent();
        ...
        [SerializeField]
        protected LineSelectionEvent m_OnLineSelection = new LineSelectionEvent();
        ...
        [SerializeField]
        protected LinkSelectionEvent m_OnLinkSelection = new LinkSelectionEvent();
        ...
        protected int m_selectedLink = -1;
        protected int m_lastCharIndex = -1;
        protected int m_lastWordIndex = -1;
        protected int m_lastLineIndex = -1;
        ...
        protected void SendOnCharacterSelection(char character, int characterIndex)
        {
            if (onCharacterSelection != null)
                onCharacterSelection.Invoke(character, characterIndex);
        }

        protected void SendOnSpriteSelection(char character, int characterIndex)
        {
            if (onSpriteSelection != null)
                onSpriteSelection.Invoke(character, characterIndex);
        }

        protected void SendOnWordSelection(string word, int charIndex, int length)
        {
            if (onWordSelection != null)
                onWordSelection.Invoke(word, charIndex, length);
        }

        protected void SendOnLineSelection(string line, int charIndex, int length)
        {
            if (onLineSelection != null)
                onLineSelection.Invoke(line, charIndex, length);
        }

        protected void SendOnLinkSelection(string linkID, string linkText, int linkIndex)
        {
