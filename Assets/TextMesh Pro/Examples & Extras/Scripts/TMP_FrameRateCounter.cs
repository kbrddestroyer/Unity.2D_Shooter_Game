...
namespace TMPro.Examples
{
    ...
    public class TMP_FrameRateCounter : MonoBehaviour
    {
        ...
        protected float m_LastInterval = 0;
        ...
        protected string htmlColorTag;
        protected const string fpsLabel = "{0:2}</color> <#8080ff>FPS \n<#FF8000>{1:2} <#8080ff>MS";

        protected TextMeshPro m_TextMeshPro;
        protected Transform m_frameCounter_transform;
        protected Camera m_camera;

        protected FpsCounterAnchorPositions last_AnchorPosition;
