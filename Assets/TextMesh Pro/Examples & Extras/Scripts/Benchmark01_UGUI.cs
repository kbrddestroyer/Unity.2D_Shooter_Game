...
namespace TMPro.Examples
{
    ...
    public class Benchmark01_UGUI : MonoBehaviour
    {
        ...
        //protected TextContainer m_textContainer;
        protected Text m_textMesh;

        protected const string label01 = "The <#0050FF>count is: </color>";
        protected const string label02 = "The <color=#0050FF>count is: </color>";

        //protected const string label01 = "TextMesh <#0050FF>Pro!</color>  The count is: {0}";
        //protected const string label02 = "Text Mesh<color=#0050FF>        The count is: </color>";

        //protected string m_string;
        //protected int m_frame;

        protected Material m_material01;
        protected Material m_material02;
