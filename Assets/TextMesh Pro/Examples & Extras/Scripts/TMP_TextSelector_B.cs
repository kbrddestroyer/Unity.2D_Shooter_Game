...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        protected RectTransform m_TextPopup_RectTransform;
        protected TextMeshProUGUI m_TextPopup_TMPComponent;
        protected const string k_LinkText = "You have selected link <#ffff00>";
        protected const string k_WordText = "Word Index: <#ffff00>";
